...
class DBHelper {
   ...
   /**
    ...
    static addRestaurants() {
      return fetch('http://18.220.2.111:1337/restaurants/')
        .then(response => {
    ...
    static updateFavorite(restaurantId, isFav) {
      ...
      fetch(`http://18.220.2.111:1337/restaurants/${restaurantId}/?is_favorite=${isFav}`, {
        method: 'PUT'
      })
      .then(() => {
    ...
    static fetchReviewsById(id) {
      return fetch(`http://18.220.2.111:1337/reviews/?restaurant_id=${id}`)
